...
const Mentors = () => {
    ...
    const third = Math.ceil(mentors.length / 3);
    const firstColumn = mentors.slice(0, third);
    const secondColumn = mentors.slice(third, third * 2);
    const thirdColumn = mentors.slice(third * 2);
    ...
    return (
        ...
        >
            <section className="relative overflow-hidden bg-black text-white py-20 pb-10">
                {/* Header */}
